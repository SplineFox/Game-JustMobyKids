...
`LocalizationService` - предоставляет локализованный текст по ключу. Файлы локализации представлены в виде json-файлов. Для каждой локали используется свой файл в формате 'Localization_<localeCode>'. 
